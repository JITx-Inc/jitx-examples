...
#         def __init__(self):
#            self.part = Part(mpn="KT-0603R", manufacturer="Hubei_KENTO_Elec")
#
# File Location: components/Hubei_KENTO_Elec/KT_0603R.py
# To use this component:
#     from .components.Hubei_KENTO_Elec import KT_0603R
#     class Example(Circuit):
#         u1 = KT_0603R.Component()
...
class SymbolKT_0603R(Symbol):
    pin_name_size = 0.7874
    pad_name_size = 0.7874
    K = Pin((-1, 1), 3, Direction.Left)
    A = Pin((1, 1), 3, Direction.Right)
    layer_reference = Text(">REF", 0.55559, Anchor.C).at((0, 4.17481))
    layer_value = Text(">VALUE", 0.55559, Anchor.C).at((0, 3.38741))
    draws = [
